...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->n:I
    ...
    iput v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->q:F
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->t:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->v:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->q:F
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->t:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->v:Ljava/util/List;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 1
    iget v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->n:I
    ...
    .line 3
    iget v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->q:F
    ...
    .line 7
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->t:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    .line 8
    iget-object p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->v:Ljava/util/List;
